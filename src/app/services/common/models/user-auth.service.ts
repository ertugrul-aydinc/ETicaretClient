...
export class UserAuthService {
  ...
  async login(userNameOrEmail:string, password:string, callBackFunction?:()=> void) : Promise<any>{+3
    ...
    if(tokenResponse){
      ...
      this.toastrService.message("Kullanıcı girişi başarılı.","Girişi Başarılı !",{
